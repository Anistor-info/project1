	...
	public function flash($key = 'flash', $attrs = array()) {
		...
		if (CakeSession::check('Message.' . $key)) {
			...
			if ($flash['element'] == 'default') {
				...
				//$out = '<div id="' . $key . 'Message" class="' . $class . '">' . $message ."<img src=".$this->base."/app/webroot/img/icon-close.png class='close_me' /></div>";
				$out = '<div class="success_message" id="flashMessage" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td width="28"><img src="'.$this->base.'/app/webroot/img/success-icon.png" width="20" height="19" /></td>
					   <td>'.$message.'</td>
						  <td align="center"><img class="close_me" src="'.$this->base.'/app/webroot/img/close-btn.png"></td>
				  </tr>
				</table></div>';
